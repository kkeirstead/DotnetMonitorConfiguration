...
namespace DotnetMonitorConfiguration.Models.BorrowedFromDM
{
    internal sealed class SchemaGenerator
    {
        public string GenerateSchema()
        {
            ...
            schema.Definitions[nameof(CollectionRule)].Properties[nameof(CollectionRule._limit)].Default = JsonSchema.CreateAnySchema();
        ...
        private static void AddCollectionRuleSchemas(GenerationContext context)
        {
            ...
            AddCollectionRuleActionSchema<CollectDump>(context, actionTypeSchema, KnownCollectionRuleActions.CollectDump);
            AddCollectionRuleActionSchema<CollectGCDump>(context, actionTypeSchema, KnownCollectionRuleActions.CollectGCDump);
            AddCollectionRuleActionSchema<CollectLogs>(context, actionTypeSchema, KnownCollectionRuleActions.CollectLogs);
            AddCollectionRuleActionSchema<CollectTrace>(context, actionTypeSchema, KnownCollectionRuleActions.CollectTrace);
            AddCollectionRuleActionSchema<Execute>(context, actionTypeSchema, KnownCollectionRuleActions.Execute);
            ...
            AddCollectionRuleTriggerSchema<AspNetRequestCount>(context, triggerTypeSchema, KnownCollectionRuleTriggers.AspNetRequestCount);
            AddCollectionRuleTriggerSchema<AspNetRequestDuration>(context, triggerTypeSchema, KnownCollectionRuleTriggers.AspNetRequestDuration);
            AddCollectionRuleTriggerSchema<AspNetResponseStatus>(context, triggerTypeSchema, KnownCollectionRuleTriggers.AspNetResponseStatus);
            AddCollectionRuleTriggerSchema<EventCounter>(context, triggerTypeSchema, KnownCollectionRuleTriggers.EventCounter);
