...
namespace DotnetMonitorConfiguration.Models.BorrowedFromDM
{
    ...
    /// </summary>
    public sealed partial class CollectionRuleOptions
    {
        //public List<ProcessFilterDescriptor> Filters { get; } = new List<ProcessFilterDescriptor>(0);

        public List<CRFilter> Filters { get; set; } = new List<CRFilter>(0);

        [Required]
        public CollectionRuleTriggerOptions Trigger { get; set; }

        public List<CollectionRuleActionOptions> Actions { get; set; } = new List<CollectionRuleActionOptions>(0);
